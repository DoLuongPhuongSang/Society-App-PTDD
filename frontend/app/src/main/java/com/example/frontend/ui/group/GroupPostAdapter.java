...
public class GroupPostAdapter extends RecyclerView.Adapter<GroupPostAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH h, int position) {
        ...
        if (reactCount > 0) {
            ...
            if (topReactions != null && !topReactions.isEmpty()) {
                ...
                h.imgReact1.setImageResource(getIconForReaction(topReactions.get(0)));
                if (topReactions.size() > 1) {
                    h.imgReact2.setVisibility(View.VISIBLE);
                    h.imgReact2.setImageResource(getIconForReaction(topReactions.get(1)));
                }
            }
        } else {
        ...
        h.imgLike.setImageResource(getIconForReaction(currentReaction));
        ...
        h.btnLike.setOnLongClickListener(v -> {
            ...
            popupView.findViewById(R.id.btnReactLike).setOnClickListener(x -> { handleReactionUpdate(h, p, "Like"); pw.dismiss(); });
            popupView.findViewById(R.id.btnReactLove).setOnClickListener(x -> { handleReactionUpdate(h, p, "Love"); pw.dismiss(); });
            popupView.findViewById(R.id.btnReactHaha).setOnClickListener(x -> { handleReactionUpdate(h, p, "Haha"); pw.dismiss(); });
            popupView.findViewById(R.id.btnReactWow).setOnClickListener(x ->  { handleReactionUpdate(h, p, "Wow");  pw.dismiss(); });
            popupView.findViewById(R.id.btnReactSad).setOnClickListener(x ->  { handleReactionUpdate(h, p, "Sad");  pw.dismiss(); });
            popupView.findViewById(R.id.btnReactAngry).setOnClickListener(x ->{ handleReactionUpdate(h, p, "Angry");pw.dismiss(); });
    ...
    private void handleReactionUpdate(VH h, GroupPost p, String newType) {
        ...
        h.imgLike.setImageResource(getIconForReaction(newType));
        ...
        if (count > 0) {
            ...
            if (!top.isEmpty()) {
                h.imgReact1.setVisibility(View.VISIBLE);
                h.imgReact1.setImageResource(getIconForReaction(top.get(0)));
                if (top.size() > 1) {
                    h.imgReact2.setVisibility(View.VISIBLE);
                    h.imgReact2.setImageResource(getIconForReaction(top.get(1)));
                }
            }
        } else {
            h.layoutTopReactions.setVisibility(View.GONE);
