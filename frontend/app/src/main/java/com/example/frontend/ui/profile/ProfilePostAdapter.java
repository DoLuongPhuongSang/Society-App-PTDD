...
public class ProfilePostAdapter extends RecyclerView.Adapter<ProfilePostAdapter.ViewHolder> {
    ...
    private int getIconForReaction(String type) {
        if (type == null) return com.example.frontend.R.drawable.ic_like;
        switch (type) {
            case "Like": return com.example.frontend.R.drawable.ic_like_color;
            case "Love": return com.example.frontend.R.drawable.ic_love;
            case "Haha": return com.example.frontend.R.drawable.ic_haha;
            case "Wow":  return com.example.frontend.R.drawable.ic_wow;
            case "Sad":  return com.example.frontend.R.drawable.ic_sad;
            case "Angry":return com.example.frontend.R.drawable.ic_angry;
            default: return com.example.frontend.R.drawable.ic_like;
        }
    }

    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvUserName, tvContent, tvCommentCount, tvReactionCount, tvLikeLabel;
        ImageView imgAvatar, imgReact1, imgReact2;
